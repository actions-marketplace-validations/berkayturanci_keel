---
description: Autonomous work block — time-aware mode (night 00-08 = no merges; day 08-24 = merge-as-you-go). Picks from priority queue, team review loop, morning/session report.
...
| Current hour | Mode | Merge rule |
|---|---|---|
| 00 – 07 | **Night** | No merges — except blockers. Write morning report at end. |
| 08 – 23 | **Day** | Merge CI-green + fully-reviewed PRs as you go. Write brief session summary at end. |

Set `MODE=night` or `MODE=day` in your reasoning and apply the correct merge rule throughout.
